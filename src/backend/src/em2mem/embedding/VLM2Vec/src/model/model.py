...
def _vlm2vec_attn_implementation() -> str:
    return os.getenv("EM2MEM_VLM2VEC_ATTN_IMPLEMENTATION", "eager").strip() or "eager"
...
class MMEBModel(nn.Module):
    ...
    def load(cls, model_args: ModelArguments, is_trainable=True, **kwargs):
        ...
        local_files_only = os.getenv("EM2MEM_ALLOW_HF_DOWNLOAD", "0").strip().lower() not in {"1", "true", "yes"}
