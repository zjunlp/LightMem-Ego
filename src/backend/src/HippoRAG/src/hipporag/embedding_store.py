...
class EmbeddingStore:
    ...
    def insert_strings(self, texts: List[str], **encode_kwargs):
        nodes_dict = {}
        ...
        # encode with any passed kwargs (e.g., modality="video", num_frames=8)
        missing_embeddings = self.embedding_model.encode(texts_to_encode, **encode_kwargs)
