...
export function useAskWorldMM(sessionId, options = {}) {
  ...
  const setLongTermRetrievalScheme = useCallback((scheme) => {
    const nextScheme = scheme === LONG_TERM_RETRIEVAL_SCHEMES.WORLDMM_LEGACY
      ? LONG_TERM_RETRIEVAL_SCHEMES.WORLDMM_LEGACY
